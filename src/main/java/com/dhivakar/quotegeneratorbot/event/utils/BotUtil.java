...
public class BotUtil {
    ...
    public static final String GET_RANDOM_QUOTE_MSG = "To get Random Quotes send " + UserCommand.RANDOM_QUOTE.getCommand();
    public static final String GET_DISABLE_MSG = "To Disable Receiving Daily Quotes send " + UserCommand.DISABLE_QUOTE_SCHEDULING.getCommand();
    ...
    public static final String RE_ENABLE_START = "To Re-Enable send " + UserCommand.START.getCommand();
    ...
    public static final String DEFAULT_INVALID_MSG = INVALID_MSG + NEXT_LINE + UserCommand.getAllAvailableCommands();
